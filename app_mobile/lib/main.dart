...
class _HomePageState extends State<HomePage> {
  ...
  final List<String> _categories = ['Tous', 'Emploi', 'Stage', 'Bourse', 'Concours', 'Formation'];
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        const SnackBar(content: Text('Notifications marqu├®es comme lues.')),
